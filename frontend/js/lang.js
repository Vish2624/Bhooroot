...
const Lang = {
  ...
  STRINGS: {
    en: {
      ...
      catEyebrow: '<iconify-icon icon="ph:leaf-fill" width="13" height="13"></iconify-icon> Shop By Category', catTitle: 'Everything Your Farm <em>Needs</em>',
    ...
    ta: {
      ...
      catEyebrow: '<iconify-icon icon="ph:leaf-fill" width="13" height="13"></iconify-icon> வகையின்படி வாங்கு', catTitle: 'உங்கள் நிலத்திற்கு <em>தேவையான</em> அனைத்தும்',
    ...
    hi: {
      ...
      catEyebrow: '<iconify-icon icon="ph:leaf-fill" width="13" height="13"></iconify-icon> श्रेणी से खरीदें', catTitle: 'आपके खेत की <em>हर ज़रूरत</em>',
